...
class AddTest extends TestCase
{
    ...
    public function testAddValuesIntoStringList(): void
    {
        ...
        self::assertSame(
            'StringLinkedList number of nodes: 85' . PHP_EOL .
     ...
     * @return void
     */
    public function testAddIntValueIntoStringList(): void
    {
        $actual = new StringLinkedList();
        $actual->add('bla bla bla');

        $message = 
            'LinkedList\StringLinkedList::add(): ' . 
            'Argument #1 ($value) must be of type string, int given, ' . 
            'called in C:\xampp\htdocs\LinkedList\tests\StringLinkedList\AddTest.php on line 351';
